...
import { INFO_ICON } from "../utils/constant";
...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="pt-[15%] px-14 text-white absolute bg-gradient-to-r from-black aspect-video w-full">
      ...
      <h1 className="my-4 w-1/3 text-lg font-semibold max-h-40 overflow-x-scroll no-scrollbar">
        {overview}
      </h1>
      <div className="flex my-2">
        ...
        <button className="rounded-md mx-4 px-8 py-2 font-semibold text-lg bg-opacity-75 bg-neutral-600 flex items-center">
          <p>More Info</p>
        </button>
      </div>
    </div>
